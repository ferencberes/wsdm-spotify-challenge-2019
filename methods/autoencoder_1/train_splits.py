# np.save("/mnt/idms/PROJECTS/recsys2018/WSDM/data/train_test/split_full/train/combined_fixed_length_orig", combined_fixed_length)
...
}, split_folder + "/models/autoencoder_1_s" + str(split))
